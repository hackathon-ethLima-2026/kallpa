...
- **Slide 6** — "Solvencia verificable / reservas ≥ pasivos" → "Integridad verificable / la caja cuadra". Cita de gas genérica (10x) → **"[X] gas medido en record_score"**. ✅ **`[X]` = 130 313 gas**, medido en la transacción real `0x7e6a313535912945fbd6d01546772f5a718f547ceb391ca3ac62ef138dc4c5b7`.
